          ...
          <input
            ...
            className={`block w-full pl-10 pr-3 py-3 rounded-lg focus:outline-none focus:ring-2 ${
              isDarkMode 
                ? 'bg-gray-800 text-white placeholder-gray-500 focus:ring-blue-600' 
                : 'bg-gray-100 text-gray-900 placeholder-gray-400 focus:ring-blue-500'
            } transition-all border-transparent border ${formErrors.password ? 'border-red-500' : ''}`}
          ...
          <input
            ...
            className={`block w-full pl-10 pr-3 py-3 rounded-lg focus:outline-none focus:ring-2 ${
              isDarkMode 
                ? 'bg-gray-800 text-white placeholder-gray-500 focus:ring-blue-600' 
                : 'bg-gray-100 text-gray-900 placeholder-gray-400 focus:ring-blue-500'
            } transition-all border-transparent border ${formErrors.confirmPassword ? 'border-red-500' : ''}`}
